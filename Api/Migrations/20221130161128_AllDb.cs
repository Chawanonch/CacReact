        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QuantityCode = table.Column<int>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UseCoupon = table.Column<string>(type: "TEXT", nullable: false),
                    UsePoint = table.Column<int>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AddImageProducts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AddImageProducts_Products_ProductId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AddProducts_Companies_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "Companies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AddProducts_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "f7b50ad3-6c90-4c5d-a8a3-e2cc694245ca", "Member", "MEMBER" });

            migrationBuilder.InsertData(
                table: "AspNetRoles",
                columns: new[] { "Id", "ConcurrencyStamp", "Name", "NormalizedName" },
                values: new object[] { 2, "160cd6e6-442d-4a67-9378-16cc2221b4f8", "Admin", "ADMIN" });

            migrationBuilder.CreateIndex(
                name: "IX_AddImageProducts_ProductId",
                table: "AddImageProducts",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_AddProducts_CompanyId",
                table: "AddProducts",
                column: "CompanyId");

            migrationBuilder.CreateIndex(
                name: "IX_AddProducts_ProductId",
                table: "AddProducts",
                column: "ProductId");
